    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText1   = QChar(0xA9)+QString(" 2009-11 ") + QString(tr("The Bitcoin developers"));
	QString copyrightText2   = QChar(0xA9)+QString(" 2011-2014 ") + QString(tr("The Litecoin developers"));
    QString copyrightText3   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The ProsperCoin developers"));
